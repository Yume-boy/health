...
{/* 
    ...
    <div class="col-12 col-sm-4 mb-3">
      ...
      <ul class="foot flex-column">
        ...
        <li class="nav-item mb-2"><a href="mailto:Contact@CarePointhealthSolutions.co.uk" class="nav-link p-0 text-body-secondary split"><Mail className='icon'/> contact@carepointhealthcaresolutions.co.uk</a></li>
      </ul>
    </div>
