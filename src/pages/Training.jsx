    ...
    <div>
      <div className=' hero-2 text-white text-center'
        ...
        <div className='d-flex align-items-center flex-column py-5' style={{backgroundColor: '#F7F7F7'}}>
          ...
          <h2 className='fs-1 mt-5 text-center lh-lg'>If this describes you and what you are looking for then a career in recruitment with CarePoint could be for you. </h2>
          <h3>To find out more contact us today.</h3>
